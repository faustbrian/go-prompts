...
func TestDynamicOptionsDebouncesBoundsAndCopies(t *testing.T) {
	...
	options[0] = mustOption(
		t,
		prompts.OptionConfig[int]{ID: "changed", Label: "Changed", Value: 2},
	)
